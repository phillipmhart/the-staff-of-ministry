...
const c7Hints = [
  ...
  `<strong>Hint #2</strong><br>Each square on your clue has its own color and pattern — the first one is green with hearts. Look at the Razzmatazz storefront sign and find a letter with that same color and pattern. That's your first letter! Do the same for the other three squares to reveal the 4-letter word.${gallery(fig('c7-storefront-hint.jpg', 'Razzmatazz Kids storefront sign'))}`,
...
function chapter1() {
  ...
  app.innerHTML = shell(`<p class="location">📍 Start at Bliss Park Playground</p>
    <h2>1716 - THE COVENANT</h2>
    <p>Back in 1716, when the General Court granted 30 acres of “Ministry Land” to support Longmeadow's first minister, Reverend Stephen Williams, it came with a covenant written into the deed.</p>
    <p>Buried beneath that land lay the <strong>Staff of Ministry</strong> — an ancient relic that kept the valley fertile, calm, and green. The covenant was simple: As long as the Staff remained in the ground, Longmeadow would thrive. If it was ever removed, the land would reclaim itself and the town would revert to wild, untamed wilderness. Settlers called it <strong>The Curse of 1716</strong>.</p>
    <p>For over 300 years, the covenant held. The Staff lay safe and forgotten. That is, until 2026.</p>
    <p>When crews excavated Bliss Park for the new playground, they unearthed a strange, perfectly preserved wooden staff. Thinking it was just a cool piece of farm junk, they incorporated it into the centerpiece of the playground — right into Mr. Potato Head's hand.</p>
    <p>They unknowingly put Longmeadow's protection on display for anyone to take.</p>
    ${gallery(fig('form-image-1.jpg', 'Mr. Potato Head before the staff got stolen'))}
    <h2>THE CRIME</h2><p>Bliss Park, Longmeadow. Today, 9:00 AM.</p>
    <p>The playground opens. Mr. Potato Head is missing his staff. A <strong>cryptic note</strong> sits in its hand.</p>
    <p>The police are on-site but brush the missing staff story off. “Missing stick? A curse?! It's just a local myth.”</p>
    <p>As you lean in to read the cryptic note, a sudden, deafening roar echoes from deep underground beneath your feet — is that... a vine growing through the pavement?</p>
    <p>A woman rushes up to you. “You saw it too, right? I'm <strong>Mrs. Orac</strong>, from the <strong>Underground Longmeadow Historical Society</strong>. The police won't listen. You have to.”</p>
    <h2>YOUR MISSION</h2><p>Mrs. Orac explains: The thief has broken the Covenant. With the Staff removed from town land, the wilderness is already coming back — fast. You have until sundown before Longmeadow is swallowed by wilderness forever.</p>
    <p>The thief left a trail of clues tied to Longmeadow's history, leading to where the Staff is hidden. Crack the clues. Retrieve the Staff. Break the Curse of 1716.</p>
...
function chapter3Start() {
  currentChapter = 3;
  app.innerHTML = shell(`<p class="location">📍 Start at the Storrs Library.</p><h2>Welcome to Storrs Library!</h2><aside class="history"><p>In 1907, Sarah Williams Storrs — granddaughter of the town's second minister, Rev. Richard Salter Storrs, and descendant of the first minister, Rev. Stephen Williams — died and left all her real estate and $5,000 in her will to establish a town library in her family's memory. This gift included the family's historic homestead at 697 Longmeadow Street, built in 1786.</p><p>The initial home of the library was established in that homestead, which became known as the Storrs House. The collection was managed by the Richard Salter Storrs Library Association.</p><p>When the current library building was constructed in 1932, the historic house was moved twelve feet to the south and about thirty feet back to make room for it. It now serves as the Storrs House Museum and Archive for the Longmeadow Historical Society.</p></aside><p>While the library has changed locations over the years, the presence of <strong>Reverend Richard Salter Storrs</strong> and several of his family members can still be felt inside.</p>${gallery(fig('chapter3/library.jpg', 'The Storrs Library'))}<section class="answer"><h3>Are you able to enter the library and look for the family portraits?</h3><button class="button" onclick="chapter3Clue()">Yes, I can enter the library.</button><button class="button ghost" onclick="chapter3Portraits()">No, the library is closed.</button></section>`);
  window.scrollTo({ top: 0 });
}
